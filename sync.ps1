# ==============================================================================
# CONFIGURATION - ПРОВЕРЬТЕ ЭТИ ПУТИ!
# ==============================================================================

# Источник: откуда делаем git pull и копируем файлы
$sourceDir = "C:/Users/3/mfua"

# Назначение: куда копируем файлы и делаем push (ВАШ РЕПОЗИТОРИЙ!)
$destDir   = "C:/Users/3/mfua8482artemk0tohin"

# Включить автоматический push? ($true или $false)
$enablePush = $true
