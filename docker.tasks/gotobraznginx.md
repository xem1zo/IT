...
![Скрин вывода поиска по слову nginx](img1/name.png)
...
![Скрин вывода curl](img1/curl.png)

Способ 2 - [открыть http://localhost/ адрес в браузере](http://localhost/)

![Скрин nginx в браузере](img1/welcome.png)
...
![Скрин состояния docker images](img1/dockerimages.png)
...
![Скрин образа](img1/dockerimages.png)
...
docker ps -a
```
![Скрин контейнера](img1/docker_ps.png)
...
fastfetch
```
![Вывод команды fastfetch](img1/fastfetch_docker.png)
